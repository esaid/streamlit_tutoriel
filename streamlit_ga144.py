...
os.chdir ( rf"{st.session_state['folder_streamlit']}" )  # path streamlit
st.write(os.getcwd())
    ...
    with placeholder_col2.container ():
        ...
        if st.session_state['projet'] is False:
            ...
            st.session_state['folder_project'] = os.path.join ( st.session_state['folder_streamlit'],
                                                                projet )  # chemin repertoire du projet
            try:
            ...
            st.session_state['list_files_project'] += f"{st.session_state['folder_project']}\n"
...
if selected_horizontal == 'New':
    ...
    if st.button:  # CTRL + ENTER
        ...
        # os.chdir ( st.session_state['folder_project'] )
